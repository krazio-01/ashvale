...
export const SPRING_SEASON: ISeasonProfile = {
    ...
    groundTint: { color: "#dff0cf", strength: 0.1, lightnessShift: 0.03 },
    skyTint: { color: "#e8f2ff", strength: 0.13 },
    lightTint: { color: "#f2ffe8", strength: 0.1 },
    keyIntensityScale: 1,
...
export const SUMMER_SEASON: ISeasonProfile = {
    ...
    groundTint: { color: "#ffeec0", strength: 0.12, lightnessShift: 0 },
    skyTint: { color: "#fff8e0", strength: 0.11 },
    lightTint: { color: "#fff2cc", strength: 0.09 },
...
export const AUTUMN_SEASON: ISeasonProfile = {
    ...
    groundTint: { color: "#d98f3f", strength: 0.24, lightnessShift: -0.02 },
    skyTint: { color: "#ffb877", strength: 0.18 },
    lightTint: { color: "#ffb96b", strength: 0.18 },
    keyIntensityScale: 0.95,
    hemisphereIntensityScale: 0.95,
    fogDensityScale: 0.95,
...
export const WINTER_SEASON: ISeasonProfile = {
    ...
    groundTint: { color: "#e8f0f8", strength: 0.42, lightnessShift: 0.16 },
    skyTint: { color: "#c3d8ef", strength: 0.28 },
    lightTint: { color: "#b8d4f5", strength: 0.34 },
